...
def cadastrar_paciente():
    ...
    try:
        ...
        flash(f"Erro ao cadastrar paciente: {erro}", 'error')
        return redirect(url_for('cadastro_de_pacientes'))
...
def cadastrar_usuario():
    ...
    try:
        ...
        flash(f"Erro ao cadastrar usuário: {erro}", 'error')
        return redirect(url_for('gerenciar_usuarios'))
...
def adicionar_anotacao():
    ...
    banco.inserir_anotacao(session['user_id'], conteudo)
